  ...
  const response = await ai.models.generateContent({
    ...
    contents: {
      parts: [
        ...
        {
          text: "Extract all information from this service receipt. Convert dates to YYYY-MM-DD format if possible. Map 'Beyond', 'Returned', or 'Waiting for Spare' checkboxes to the respective fields. Specifically look for a Serial Number if present.",
        },
      ],
    },
    config: {
      ...
      responseSchema: {
        ...
        properties: {
          ...
          materialStatus: { type: Type.STRING, description: "One of: Serviced, Beyond, Returned, Waiting for Spare" },
